...
function NonVerbal() {
        ...
        const toggleText = () => {
              ...
              useLayoutEffect(() => {
                if (isVisible) {
                  elementRef.current.classList.add("text-article-visible");
                  elementRef.current.classList.add("text-article-visible-left");
                  elementRef.current.classList.add("text-article-visible");
  ...
  return (
    ...
    <section className='title-text-container'>
        ...
        <p  ref={elementRef} className='text-article'>Le langage non-verbal est incroyablement puissant. C'est une forme de
...
intentions et des attitudes sans prononcer le moindre mot.</p>
        ...
        <p  ref={elementRef} className='text-article'>Quand on y pense, c'est assez fascinant. Nos expressions faciales peuvent révéler
...
détourné pour exprimer de la gêne.</p>
        ...
        <p  ref={elementRef} className='text-article'>En tant que coach, je suis convaincu que le langage non-verbal est essentiel pour
